...
public class EventJoinController {
    ...
    @PostMapping()
    public ResponseEntity<ApiResponse<EventJoinResponse>> createEventJoin(@GetUserId Long user, @Valid @RequestBody EventJoinCreateRequest eventJoinCreateRequest) {
        EventJoinResponse eventJoinResponse = eventJoinService.createEventJoin(user, eventJoinCreateRequest);
    ...
    @GetMapping("/event")
    public ResponseEntity<ApiResponse<List<EventJoinResponse>>> getUserEvents(@GetUserId Long userId) {
        List<EventJoinResponse> eventJoinResponses = eventJoinService.getUserEvents(userId);
    ...
    public ResponseEntity<Boolean> checkApplication(@GetUserId Long userId, @PathVariable Long eventId) {
        boolean isApplied = eventJoinService.isEventJoin(userId, eventId);
    ...
    public ResponseEntity<Void> deleteEventJoin(@GetUserId Long userId, @PathVariable Long eventId) {
        eventJoinService.deleteEventJoin(userId, eventId);
